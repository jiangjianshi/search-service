...
* 
*/
package com.huifenqi.search.context.dto.request.house;
...
public class HouseSearchDto {
	...
	//收藏列表房源
    private List<String> collectHouseList;

    //收藏列表房间
    private List<String> collectRoomList;
    
    //收藏列表房源标识
    private List<String> collectFlagHouseList;

    //收藏列表房间标识
    private List<String> collectFlagRoomList;
    
    //足迹列表房源
    private List<String> footHouseList;

    //足迹列表房间
    private List<String> footRoomList;
	...
	public String getJiucuokeyword() {
		return jiucuokeyword;
	}

	public void setJiucuokeyword(String jiucuokeyword) {
		this.jiucuokeyword = jiucuokeyword;
	}
    ...
    public List<String> getCollectHouseList() {
        return collectHouseList;
    }

    public void setCollectHouseList(List<String> collectHouseList) {
        this.collectHouseList = collectHouseList;
    }

    public List<String> getCollectRoomList() {
        return collectRoomList;
    }

    public void setCollectRoomList(List<String> collectRoomList) {
        this.collectRoomList = collectRoomList;
    }

    
    public List<String> getFootHouseList() {
        return footHouseList;
    }

    public void setFootHouseList(List<String> footHouseList) {
        this.footHouseList = footHouseList;
    }

    public List<String> getFootRoomList() {
        return footRoomList;
    }

    public void setFootRoomList(List<String> footRoomList) {
        this.footRoomList = footRoomList;
    }
    ...
    public List<String> getCollectFlagHouseList() {
        return collectFlagHouseList;
    }

    public void setCollectFlagHouseList(List<String> collectFlagHouseList) {
        this.collectFlagHouseList = collectFlagHouseList;
    }

    public List<String> getCollectFlagRoomList() {
        return collectFlagRoomList;
    }

    public void setCollectFlagRoomList(List<String> collectFlagRoomList) {
        this.collectFlagRoomList = collectFlagRoomList;
    }

    @Override
    public String toString() {
        return "HouseSearchDto [userId=" + userId + ", sellId=" + sellId + ", keyword=" + keyword + ", processkeyword="
                + processkeyword + ", jiucuokeyword=" + jiucuokeyword + ", hasDigit=" + hasDigit + ", cityId=" + cityId
                + ", districtId=" + districtId + ", bizId=" + bizId + ", lineId=" + lineId + ", stationId=" + stationId
                + ", price=" + price + ", orientation=" + orientation + ", area=" + area + ", entireRent=" + entireRent
                ...
                + companyOffList + ", houseList=" + houseList + ", roomList=" + roomList + ", collectHouseList="
                + collectHouseList + ", collectRoomList=" + collectRoomList + ", collectFlagHouseList="
                + collectFlagHouseList + ", collectFlagRoomList=" + collectFlagRoomList + ", footHouseList="
                + footHouseList + ", footRoomList=" + footRoomList + ", isHomePage=" + isHomePage + ", isCollect="
                + isCollect + ", isFoot=" + isFoot + "]";
    }
