...
* 
*/
package com.huifenqi.search.context.entity.platform;
...
public class PlatformCustomer {
     ...
     * 是否调权  0否      1是
     */
    @Column(name = "f_is_weight")
    private Integer isWeight;
    
      /**
      * 调权值
      */
    @Column(name = "f_weight_value")
    ...
    public String toString() {
        return "PlatformCustomer [id=" + id + ", appId=" + appId + ", source=" + source + ", secretKey=" + secretKey
                ...
                + permissionEnd + ", permissionStatus=" + permissionStatus + ", isSaas=" + isSaas + ", isWeight="
                + isWeight + ", weightValue=" + weightValue + ", isImg=" + isImg + ", imageCss=" + imageCss
