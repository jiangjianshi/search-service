 ...
 * 
 */
package com.huifenqi.search.monitor;

import java.util.Date;

import javax.servlet.http.HttpServletRequest;

import com.huifenqi.search.utils.AccessLogUtils;
import com.huifenqi.search.comm.Request;
import com.huifenqi.search.utils.LogUtil;
...
import com.huifenqi.search.context.response.ResponseMeta;
...
public class HandlerMonitor {
	...
	@Around("execution(public com.huifenqi.search.context.response.Responses com.huifenqi.search.controller..*.*(..))")
